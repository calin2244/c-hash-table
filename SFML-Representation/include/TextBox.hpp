...
public:
    ...
    */
    ...
    void writeHashTableText(const std::string_view key, const std::string_view val, const size_t hash, 
        const color& key_color = color::White, const color& value_color = color::White, 
        const color& hash_color = color::White) noexcept;
    void writeValueText(const std::string_view valText,
